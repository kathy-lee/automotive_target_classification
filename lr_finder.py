...
class LRFinder:
    ...
    def find(self, train_data, steps_per_epoch, use_gen=False,
             ...
             batch_size=32, workers=1, use_multiprocessing=False, verbose=1):
        """
        ...
        original_lr = get_value(self.model.optimizer.lr)

        # Set the initial learning rate
        set_value(self.model.optimizer.lr, start_lr)
        ...
        set_value(self.model.optimizer.lr, original_lr)
